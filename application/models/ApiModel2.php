...
class ApiModel2 extends CI_Model
{
	...
	public function getDataBacaan($idbaca)
	{
		...
		$sql = "SELECT pel.id as idPel,pel.no_langganan as cIdPel, pel.nama as vcNmPel,pel.alamat as vcAlamat,pel.tanggal_ganti_water_meter as dTglGantiMeter,pel.telepon as cNoTelp,jln.nama as vcJalan,lurah.nama as vcWilayah,
