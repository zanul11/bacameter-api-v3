...
class BacameterApi2 extends REST_Controller
{
    ...
    public function index_get()
    {
        ...
        return $this->response(array('status' => true, 'message' => 'Api Bacameter versi 2.4.0 (connected with Aplikasi Pengaduan, update no telpon where not valid)', 'cBlth' => date('m/Y')));
    }
