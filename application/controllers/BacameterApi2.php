...
class BacameterApi2 extends REST_Controller
{
    ...
    {
        return $this->response(array('status' => true, 'message' => 'Api Bacameter versi 2.0 (connected with Aplikasi Pelayanan, check auto v2)', 'cBlth' => date('m/Y'), 'host' => $this->db->hostname, 'db' => $this->db->database, "php" => phpversion()));
    }
